...
GRPO training and evaluation with required data generation.
...
## 8) snelle test
Het testen met nieuwe data kan heel lang duren, daarom kan je 'curl "http://localhost:5000/start?target=100"' plakken in een nieuwe
terminal om de hoeveelheid conversations omlaag te helpen en sneller test data te genereren.
